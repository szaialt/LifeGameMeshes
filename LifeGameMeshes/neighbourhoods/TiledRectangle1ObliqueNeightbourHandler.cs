namespace neighbourhoods {
  ...
  public class TiledRectangle1ObliqueNeightbourHandler : NeightbourHandler {

    private TiledRectangle1UlamNeightbourHandler phc;
  //OBLIQUE neighbourhood for the mesh TILED_RECTANGLE1

    public TiledRectangle1ObliqueNeightbourHandler(){
